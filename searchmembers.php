...
if ($op == 'form') {
    ...
    $icq_tray  = new XoopsFormElementTray(_MD_XOOPSMEMBERS_ICQ, '&nbsp;');
    ...
    $aim_tray  = new XoopsFormElementTray(_MD_XOOPSMEMBERS_AIM, '&nbsp;');
    ...
    $yim_tray  = new XoopsFormElementTray(_MD_XOOPSMEMBERS_YIM, '&nbsp;');
    ...
    $msnm_tray  = new XoopsFormElementTray(_MD_XOOPSMEMBERS_MSNM, '&nbsp;');
    ...
    $sort_select->addOptionArray(['uname' => _MD_XOOPSMEMBERS_UNAME, 'email' => _MD_XOOPSMEMBERS_EMAIL, 'last_login' => _MD_XOOPSMEMBERS_LASTLOGIN, 'user_regdate' => _MD_XOOPSMEMBERS_REGDATE, 'posts' => _MD_XOOPSMEMBERS_POSTS]);
