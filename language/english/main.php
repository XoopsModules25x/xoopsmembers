...
define('_MD_XOOPSMEMBERS_ICQ', 'ICQ Number');
define('_MD_XOOPSMEMBERS_AIM', 'AIM Handle');
define('_MD_XOOPSMEMBERS_YIM', 'YIM Handle');
define('_MD_XOOPSMEMBERS_MSNM', 'MSNM Handle');
