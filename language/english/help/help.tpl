<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_XOOPSMEMBERS_HELP_HEADER}>
    <h4 class="odd">DESCRIPTION</h4><br>


    XOOPS Members shows a list of registered users.<br><br>
    ...
    There is no setup on the Admin side<br><br>
    On the user side, just select the criteria to search on, and click submit to search users<br><br>
    ...
    <p class="even">This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/XoopsModulesArchive/ZZZZZZZZ" target="_blank">GitHub</a><br><br>
